...
assert ("tokio","=1.53.1",False,("sync",)) in normal
...
printf '%s\n' 'ok: OA-03 adds no dependency or feature'
...
printf '%s\n' 'ok: OA-01 fixture and OA-04+ implementation surfaces remain frozen/deferred'
